  ...
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Toggle(StrId::STR_BUTTON_HINTS, &CrossPointSettings::showButtonHints, "showButtonHints",
                            StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_INTERFACE_SIZE, &CrossPointSettings::uiDensity,
                          {StrId::STR_STANDARD, StrId::STR_COMPACT}, "uiDensity", StrId::STR_CAT_DISPLAY),
        ...
        SettingInfo::Enum(
            ...
            {StrId::STR_TIGHT, StrId::STR_NORMAL, StrId::STR_WIDE, StrId::STR_EXTRA_WIDE, StrId::STR_MAXIMUM},
